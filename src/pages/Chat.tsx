...
function ComposerBox({ textareaRef, fileInputRef, input, setInput, onKeyDown, onSend, disabled, sendDisabled, placeholder, attachedFiles, onRemoveFile, onFileSelect, agent, model, onSlashCommand, onAgentChange, onModelChange, isStreaming, onAbort }: ComposerBoxProps) {
  ...
  return (
    <div className="relative w-full">
      ...
      <div
        className={cn(
          "flex flex-col rounded-[32px] px-4 pt-2.5 pb-2.5 transition-all duration-150",
        ...
        >
          ...
          >
            ...
            <div className="absolute left-1/2 -translate-x-1/2">
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                   <button className="flex items-center gap-3 px-5 py-2.5 rounded-full text-base font-medium transition-all duration-150 border border-border/50 bg-[hsl(0,0%,14%)] hover:bg-[hsl(0,0%,18%)] text-foreground select-none">
