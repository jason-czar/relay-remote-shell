        ...
        >
          ...
          >
            ...
            <div className="absolute left-1/2 -translate-x-1/2">
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                   <button className="flex items-center gap-3 px-5 py-2.5 rounded-full text-base font-medium transition-all duration-150 border border-border/30 bg-transparent hover:bg-accent text-foreground select-none">
            ...
            <div className="ml-auto flex items-center gap-3">
              <Popover>
                <PopoverTrigger asChild>
                  <button className="flex items-center gap-2 px-3.5 py-2 rounded-full text-sm font-medium transition-all duration-150 border border-border/30 bg-transparent hover:bg-accent text-foreground/80 hover:text-foreground">
                    {(() => {
