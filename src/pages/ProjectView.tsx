                          ...
                          <div className="flex items-center gap-3 mt-1">
                            ...
                            {device.pairing_code && !device.paired && (
                              <>
                                ...
                                <button
                                  onClick={() => {
                                    const cmd = `go build -o relay-connector .\n./relay-connector --pair ${device.pairing_code} --api ${import.meta.env.VITE_SUPABASE_URL}/functions/v1 --name "${device.name || "MyDevice"}"`;
